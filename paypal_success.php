...
<?php
		...
		echo "<h2>Welcome Guest, Payment was failed</h2><br>";
			...
			$headers .= 'From: <sales@dummyshop.com>' . "\r\n";
			...
			Hello dear <b style='color:blue;'>$c_name</b> you have ordered some products on our website dummyshop.com, please find your order details, your order will be processed shortly. Thank you!</p>

				<table width='600' align='center' bgcolor='#FFCC99' border='2'>

					<tr align='center'><td colspan='6'><h2>Your Order Details from dummyshop.com</h2></td></tr>
